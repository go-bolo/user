module github.com/go-catupiry/user

go 1.17

require (
	github.com/go-catupiry/catu v0.4.0
	github.com/go-catupiry/metatags v0.0.1
...
require (
	...
	github.com/go-catupiry/system_settings v0.0.1 // indirect
